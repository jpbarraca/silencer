...
var categories = {
    ...
    'encryption': {
        ...
        'options': [{
            ...
            'desc': 'Enable AES-GCM encryption for notification mirroring on Android devices (requires PushBullet Android app extension)'
        }]
    },
    'notifications': {
    ...
    if (window.chrome) {
        ...
        (function() {
            ...
            var onPermissionUpdate = function(granted) {
                ...
                if (!hasPermission && navigator.platform == 'MacIntel') {
                    clipboardPermission.style.display = 'none';
                }
            };
